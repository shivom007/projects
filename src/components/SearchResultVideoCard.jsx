...
const SearchResultVideoCard = ({ video }) => {
    return (
        <Link to={`/video/${video?.videoId}`}>
            <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-[#d3d3d3]/[0.6] rounded-xl md:p-4">
                ...
                <div className="flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden">
                    ...
                    <span className="empty:hidden text-sm line-clamp-1 md:line-clamp-2 text-black/[0.6] md:pr-24 md:my-4">
                    ...
                    <div className="hidden md:flex items-center">
                        ...
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold mt-2 text-black/[0.6] flex items-center">
                                {video?.author?.title}
                            ...
                            <div className="flex text-sm font-semibold text-black/[0.6] truncate overflow-hidden">
